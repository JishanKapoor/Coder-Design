...
export const POST = async (req: NextRequest) => {
  ...
  `                <a href="${cta.heroSecondaryLink || '/contact'}" target="_blank" rel="noopener noreferrer">${cta.heroSecondary}</a>`,
  '              </Button>',
  '            </div>',
      '          </div>',
      '        </div>',
  ...
  `                <a href="${cta.sectionSecondaryLink || '/contact'}" target="_blank" rel="noopener noreferrer">${cta.sectionSecondary}</a>`,
  '              </Button>',
      '            </div>',
      '          </div>',
      '        </div>',
