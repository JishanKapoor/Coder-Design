      ...
      <section className="bg-blue-600 py-16 text-center text-white">
        <div className="mx-auto max-w-2xl px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button onClick={() => setShowCalendar(true)} className="bg-white text-blue-600 hover:bg-white/90">
          ...
          >
            ...
            <div className="flex gap-3">
              <a href="https://calendly.com/coderdesign/30min" target="_blank" rel="noopener noreferrer" className="flex-1">
                <Button className="w-full bg-blue-600 text-white hover:bg-blue-700">Book on Calendly</Button>
              </a>
