      ...
      <section className="relative overflow-hidden bg-blue-600 py-20 lg:py-28">
        <div className="relative mx-auto max-w-4xl px-6 lg:px-12">
          <div>
            ...
            <h1 className="mb-6 text-white">Mobile App Development Guide 2025</h1>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button variant="overlay" asChild>
                <a href="https://calendly.com/hello-coderdesign/30min" target="_blank" rel="noopener noreferrer">App Development Roadmap</a>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="text-center">
            <h2 className="mb-6 text-white text-3xl font-bold">
              Ship Your Mobile App Faster with Expert Guidance
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Button size="lg" className="bg-white text-blue-600 hover:bg-white/90" asChild>
                <Link href="/contact">Develop Your App</Link>
              </Button>
              <Button size="lg" variant="overlay" asChild>
                <a href="https://calendly.com/hello-coderdesign/30min" target="_blank" rel="noopener noreferrer">Get a Dev Roadmap</a>
              </Button>
            </div>
          </div>
        </div>
