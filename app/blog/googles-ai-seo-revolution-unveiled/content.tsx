          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Button className={"gap-2 bg-white text-emerald-600 hover:bg-white/90"} asChild>
                <Link href="/contact">Future-Proof Your SEO</Link>
              </Button>
              <Button variant="overlay" onClick={() => setShowCalendar(true)}>Get an SEO Audit</Button>
            </div>
          </div>
        </div>
      </section>
...
<h2>Preparing for the AI Search Landscape</h2>
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="text-center">
            <h2 className="mb-6 text-white text-3xl font-bold">
              Stay Ahead of Google’s AI Search Revolution
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Button size="lg" className={"bg-white text-emerald-600 hover:bg-white/90"} asChild>
                <Link href="/contact">Prepare for AI Search</Link>
              </Button>
              <Button size="lg" variant="overlay" onClick={() => setShowCalendar(true)}>Get an SEO Audit</Button>
            </div>
          </div>
        </div>
      </section>
