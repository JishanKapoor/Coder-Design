    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">How to Add Random Letters to Text</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Insert random letters into words for testing.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              { step: 1, title: "Enter Text", description: "Paste your text." },
              { step: 2, title: "Configure Settings", description: "Set how many random letters to insert." },
              { step: 3, title: "Click Generate", description: "Inject random letters." },
      ...
      <section className="border-t border-slate-200 bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-5xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">Why Use Our Random Letter Inserter?</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Add random letters for testing, typo simulation, or data augmentation.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Zap, title: "Instant Injection", description: "Add random letters across your text in one click." },
              { icon: Shield, title: "100% Private", description: "Processing happens in your browser." },
              { icon: Shuffle, title: "Configurable", description: "Control the density of random letters." },
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-xl text-sm text-slate-500">See how random letter insertion is used.</p>
          </div>
          <div className="space-y-4">
            {[
              { title: "Typo Simulation", before: "Hello World", after: "Helxlo Worbld" },
              { title: "OCR Testing", before: "Invoice #123", after: "Invojice #1z23" },
              { title: "Data Augmentation", before: "test input", after: "tesqt inpukt" },
              { title: "Robustness Testing", before: "password", after: "passwmord" },
            ].map((uc) => (
