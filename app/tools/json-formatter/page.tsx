...
export const metadata: Metadata = {
  ...
  openGraph: { title: "JSON Formatter & Validator — Free Online Tool", description: "Format, validate, and beautify JSON data online.", url: "https://www.coderdesign.com/tools/json-formatter", siteName: "CoderDesign", type: "website" },
  twitter: { card: "summary_large_image", title: "JSON Formatter & Validator — Free Online Tool | CoderDesign", description: "Format, validate, and beautify JSON data online." },
