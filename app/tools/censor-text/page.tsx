...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Censor Text — Free Online Tool", description: "Replace specific words with censored characters like asterisks or custom symbols.", url: "https://www.coderdesign.com/tools/censor-text", siteName: "CoderDesign", type: "website", locale: "en_CA", images: [{ url: "https://coderdesign.com/og-image.png", width: 1200, height: 630, alt: "CoderDesign Free Online Tools" }] },
  twitter: { card: "summary_large_image", title: "Censor Text — Free Online Tool | CoderDesign", description: "Replace specific words with censored characters like asterisks or custom symbols.", images: ["https://coderdesign.com/og-image.png"] },
...
export default function Page() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebApplication", name: "Censor Text", url: "https://www.coderdesign.com/tools/censor-text", applicationCategory: "UtilityApplication", operatingSystem: "All", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, description: "Replace specific words with censored characters like asterisks or custom symbols.", "provider": { "@type": "Organization", "name": "CoderDesign", "@id": "https://coderdesign.com/#organization" }, "inLanguage": "en-CA" }) }} />
      <CensorTextTool />
    </>
  );
}
