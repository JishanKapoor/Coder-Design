    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">How to Duplicate Words</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Repeat each word in your text a specific number of times.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              { step: 1, title: "Enter Text", description: "Type or paste text." },
              { step: 2, title: "Set Count", description: "Choose how many times each word repeats." },
              { step: 3, title: "Click Duplicate", description: "Process text instantly." },
              { step: 4, title: "Copy Result", description: "Copy or download output." },
            ].map((item) => (
      ...
      <section className="border-t border-slate-200 bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-5xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">Why Use Our Word Duplicator?</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Repeat every word in your text for creative or testing needs.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Zap, title: "Instant Processing", description: "Duplicate all words across your text in one click." },
              ...
              { icon: CopyPlus, title: "Custom Count", description: "Repeat words 2×, 3×, 5× or any number of times." },
              { icon: Copy, title: "Easy Export", description: "Copy or download with one click." },
              { icon: Zap, title: "No Sign-Up", description: "Use immediately without an account." },
            ].map((f) => (
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-xl text-sm text-slate-500">See how word duplication is used.</p>
          </div>
          <div className="space-y-4">
            {[
              { title: "Creative Writing", before: "Hello World", after: "Hello Hello World World" },
              { title: "Emphasis Effect", before: "buy now", after: "buy buy buy now now now" },
              { title: "Testing Data", before: "test input", after: "test test test input input input" },
              { title: "Poetic Repetition", before: "run fast", after: "run run fast fast" },
            ].map((uc) => (
