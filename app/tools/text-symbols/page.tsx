...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Text Symbols & Special Characters — Free Online Tool", description: "Browse and copy hundreds of special characters, symbols, and Unicode characters.", url: "https://www.coderdesign.com/tools/text-symbols", siteName: "CoderDesign", type: "website" },
  twitter: { card: "summary_large_image", title: "Text Symbols & Special Characters — Free Online Tool | CoderDesign", description: "Browse and copy hundreds of special characters and symbols." },
