...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Word Replacer — Free Online Tool", description: "Find and replace specific words in any text with multiple replacements.", url: "https://www.coderdesign.com/tools/word-replacer", siteName: "CoderDesign", type: "website" },
  twitter: { card: "summary_large_image", title: "Word Replacer — Free Online Tool | CoderDesign", description: "Find and replace specific words in any text with multiple replacements." },
