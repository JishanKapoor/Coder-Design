...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Trim Text — Free Online Tool", description: "Trim characters from the left, right, or both sides of each line.", url: "https://www.coderdesign.com/tools/trim-text", siteName: "CoderDesign", type: "website", locale: "en_CA", images: [{ url: "https://coderdesign.com/og-image.png", width: 1200, height: 630, alt: "CoderDesign Free Online Tools" }] },
  twitter: { card: "summary_large_image", title: "Trim Text — Free Online Tool | CoderDesign", description: "Trim characters from the left, right, or both sides of each line.", images: ["https://coderdesign.com/og-image.png"] },
