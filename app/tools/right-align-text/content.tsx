    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">How to Right-Align Text</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Align text to the right with custom line width.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              { step: 1, title: "Enter Text", description: "Paste text to align." },
              { step: 2, title: "Set Width", description: "Choose the target line width." },
              { step: 3, title: "Click Align", description: "Right-align text instantly." },
      ...
      <section className="border-t border-slate-200 bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-5xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">Why Use Our Right-Align Tool?</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Right-align text for clean formatting and code alignment.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Zap, title: "Instant Alignment", description: "Right-align text in milliseconds." },
              { icon: Shield, title: "100% Private", description: "Processing happens locally." },
              { icon: AlignRight, title: "Custom Width", description: "Set any target line width." },
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-xl text-sm text-slate-500">See how right-alignment is used.</p>
          </div>
          <div className="space-y-4">
            {[
              { title: "Code Comments", before: "// TODO\n// FIXME", after: "     // TODO\n    // FIXME" },
              { title: "Table Data", before: "Price\nTotal", after: "     Price\n     Total" },
              { title: "Poetry", before: "Roses\nViolets", after: "     Roses\n   Violets" },
              { title: "Labels", before: "Name:\nEmail:", after: "     Name:\n    Email:" },
            ].map((uc) => (
