    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">How to Right-Pad Text</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Pad text on the right to a fixed width.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              { step: 1, title: "Enter Text", description: "Paste text to pad." },
              { step: 2, title: "Set Width", description: "Choose target width." },
              { step: 3, title: "Click Pad", description: "Add padding instantly." },
      ...
      <section className="border-t border-slate-200 bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-5xl px-6 lg:px-12">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 lg:text-3xl">Why Use Our Right-Pad Tool?</h2>
            <p className="mx-auto max-w-2xl text-slate-600">Pad text to uniform width for clean data formatting.</p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: AlignRight, title: "Custom Character", description: "Pad with spaces, dots, or any character." },
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-xl text-sm text-slate-500">See how right-padding is used.</p>
          </div>
          <div className="space-y-4">
            {[
              { title: "Fixed-Width Files", before: "John\nJane", after: "John........\nJane........" },
              { title: "Data Alignment", before: "100\n2000", after: "100 \n2000" },
              { title: "Report Columns", before: "Item\nTotal", after: "Item....\nTotal..." },
              { title: "Log Formatting", before: "OK\nERROR", after: "OK   \nERROR" },
            ].map((uc) => (
