...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Reverse Text — Free Online Tool", description: "Reverse text, words, or lines instantly. Free, fast, private.", url: "https://www.coderdesign.com/tools/reverse-text", siteName: "CoderDesign", type: "website", locale: "en_CA", images: [{ url: "https://coderdesign.com/og-image.png", width: 1200, height: 630, alt: "CoderDesign Free Online Tools" }] },
  twitter: { card: "summary_large_image", title: "Reverse Text — Free Online Tool | CoderDesign", description: "Reverse text, words, or lines instantly.", images: ["https://coderdesign.com/og-image.png"] },
