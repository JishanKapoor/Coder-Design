...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Truncate Text — Free Online Tool", description: "Remove words or characters from the end of your text. Set max length by character or word count.", url: "https://www.coderdesign.com/tools/truncate-text", siteName: "CoderDesign", type: "website", locale: "en_CA", images: [{ url: "https://coderdesign.com/og-image.png", width: 1200, height: 630, alt: "CoderDesign Free Online Tools" }] },
  twitter: { card: "summary_large_image", title: "Truncate Text — Free Online Tool | CoderDesign", description: "Remove words or characters from the end of your text.", images: ["https://coderdesign.com/og-image.png"] },
...
export default function Page() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebApplication", name: "Truncate Text", url: "https://www.coderdesign.com/tools/truncate-text", applicationCategory: "UtilityApplication", operatingSystem: "All", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, description: "Remove words or characters from the end of your text. Set max length by character or word count.", "provider": { "@type": "Organization", "name": "CoderDesign", "@id": "https://coderdesign.com/#organization" }, "inLanguage": "en-CA" }) }} />
      <TruncateTextTool />
    </>
  );
}
