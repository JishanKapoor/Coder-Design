...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Italic Text Generator — Free Online Tool", description: "Convert text to italic Unicode characters for social media and bios.", url: "https://www.coderdesign.com/tools/italic-text-generator", siteName: "CoderDesign", type: "website", locale: "en_CA", images: [{ url: "https://coderdesign.com/og-image.png", width: 1200, height: 630, alt: "CoderDesign Free Online Tools" }] },
  twitter: { card: "summary_large_image", title: "Italic Text Generator — Free Online Tool | CoderDesign", description: "Convert text to italic Unicode characters for social media and bios.", images: ["https://coderdesign.com/og-image.png"] },
