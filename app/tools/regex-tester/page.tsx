...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Regex Tester — Free Online Tool", description: "Test and debug regular expressions in real-time.", url: "https://www.coderdesign.com/tools/regex-tester", siteName: "CoderDesign", type: "website", locale: "en_CA", images: [{ url: "https://coderdesign.com/og-image.png", width: 1200, height: 630, alt: "CoderDesign Free Online Tools" }] },
  twitter: { card: "summary_large_image", title: "Regex Tester — Free Online Tool | CoderDesign", description: "Test and debug regular expressions in real-time.", images: ["https://coderdesign.com/og-image.png"] },
...
export default function Page() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebApplication", name: "Regex Tester", url: "https://www.coderdesign.com/tools/regex-tester", applicationCategory: "UtilityApplication", operatingSystem: "All", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, description: "Test and debug regular expressions in real-time.", "provider": { "@type": "Organization", "name": "CoderDesign", "@id": "https://coderdesign.com/#organization" }, "inLanguage": "en-CA" }) }} />
      <RegexTesterTool />
    </>
  );
}
