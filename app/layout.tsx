...
export const metadata: Metadata = {
  ...
  description:
    "Top AI agency and software development company in Toronto. Custom full stack website development, mobile apps, AI chatbots, call bots, intelligent automation, and AI-powered SEO services. 100+ projects delivered for startups and SMBs. (437) 239-2448.",
  keywords:
